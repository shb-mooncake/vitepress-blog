import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as r,e as t,f as n}from"./app-n0UGGgPm.js";const o={},s=n(`<h2 id="策略模式" tabindex="-1"><a class="header-anchor" href="#策略模式" aria-hidden="true">#</a> 策略模式</h2><p>定义：定义了一系列的算法，并将每个算法封装起来，使它们可以互相替换</p><p>对于策略模式的理解：就是将原来写在一个函数中一整套功能，拆分为一个个独立的部分，从而达到解耦的目的。所以策略模式最好的应用场景，就是拆解 if-else，把每个 if 模块封装为独立算法</p><h2 id="前端策略模式应用" tabindex="-1"><a class="header-anchor" href="#前端策略模式应用" aria-hidden="true">#</a> 前端策略模式应用</h2><p>实际上在前端开发中，通常不会使用到面向对象的模式，在前端中应用策略模式，完全可以简化为两个部分</p><p>对象：存储策略算法，并通过 key 匹配对应算法</p><p>策略方法：实现 key 对应的具体策略算法</p><p>javascript 版本的策略模式</p><pre><code>var strategies = {
    &quot;S&quot;: function( salary ){
        return salary * 4;
    },
    &quot;A&quot;: function( salary ){
